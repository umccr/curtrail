...
from common.log.log_data_api_calls import LogDataApiCall
from common.log.log_data_console import LogDataConsole
from common.log.log_data_service_event import LogDataServiceEvent
...
class LogData:
    ...
    def accounts(self) -> List[str]:
        return (
            self.complete_logs().get_column("account").unique().to_list()
        )
    ...
    def regions(self) -> List[str]:
        return (
            self.complete_logs().get_column("region").unique().to_list()
        )
